  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0f14', color: '#e8eaed' }}>
      ...
      <div style={{ 
        ...
        ⚡ LIMITED TIME: Get up to $1,400+ in bonuses FREE — Ends in 48 hours!
      </div>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '3rem 1.5rem' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
          <div style={{ 
            background: plan.id === 'full' ? 'linear-gradient(135deg, #2dd4bf, #5eead4)' : 'rgba(45, 212, 191, 0.15)',
            color: plan.id === 'full' ? '#0a0f14' : '#2dd4bf',
          ...
          <h1 style={{ fontSize: '2.5rem', fontFamily: 'Playfair Display, serif', marginBottom: '0.5rem' }}>
            Complete Your <span style={{ background: 'linear-gradient(135deg, #2dd4bf, #5eead4)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>Purchase</span>
          </h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '2.5rem' }}>
          {/* Left: Order Summary */}
          <div style={{ background: '#111920', borderRadius: '24px', padding: '2.5rem', border: '1px solid rgba(45, 212, 191, 0.12)' }}>
            {/* Savings Badge */}
            <div style={{ 
            ...
            <p style={{ color: '#8b949e', fontSize: '0.95rem', marginBottom: '1.5rem' }}>{plan.description}</p>
            ...
            <div style={{ 
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: '0.5rem', marginBottom: '0.5rem' }}>
                <span style={{ color: '#2dd4bf', fontSize: '1.5rem' }}>NZ$</span>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                ...
                <span style={{ color: '#8b949e', fontSize: '1rem', textDecoration: 'line-through' }}>
            ...
            {/* Features List */}
            <h4 style={{ fontSize: '0.85rem', color: '#2dd4bf', textTransform: 'uppercase', letterSpacing: '0.05em', marginBottom: '1rem' }}>
              What's Included
            </h4>
            <ul style={{ listStyle: 'none', marginBottom: '2rem' }}>
              {plan.features.map((feature, i) => (
                <li key={i} style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '0.75rem 0', borderBottom: '1px solid rgba(45, 212, 191, 0.06)' }}>
                  <span style={{ fontSize: '1.25rem' }}>{feature.icon}</span>
                  <span style={{ color: '#e8eaed', fontSize: '0.95rem' }}>{feature.text}</span>
                </li>
              ))}
            </ul>
            ...
            <div style={{ 
              ...
              {plan.bonuses.map((bonus, i) => (
                <div key={i} style={{ 
                  ...
                  gap: '0.75rem',
                  padding: '0.5rem 0',
                  color: bonus.highlight ? '#e8eaed' : '#8b949e',
                  fontSize: '0.95rem'
                }}>
                  <span style={{ color: '#2dd4bf', fontWeight: 700 }}>✓</span>
                  <span style={{ color: bonus.highlight ? '#fff' : '#8b949e' }}>{bonus.text}</span>
                </div>
              ))}
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              <div style={{ 
                ...
                <span style={{ color: '#e8eaed' }}>{plan.deliveryTime}</span>
              </div>
              <div style={{ 
                padding: '1rem',
                background: 'rgba(45, 212, 191, 0.08)',
                ...
                <span style={{ color: '#2dd4bf', fontSize: '0.95rem' }}>🛡️ {plan.guarantee}</span>
              </div>
            </div>
          </div>
          ...
          {/* Right: Payment Form */}
          <div style={{ background: '#111920', borderRadius: '24px', padding: '2.5rem', border: '1px solid rgba(45, 212, 191, 0.12)' }}>
            <h2 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', paddingBottom: '1rem', borderBottom: '1px solid rgba(45, 212, 191, 0.12)' }}>
              Payment Details
            </h2>

            {/* Stripe Badge */}
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '2rem', padding: '1rem', background: 'rgba(45, 212, 191, 0.05)', borderRadius: '10px' }}>
              <svg viewBox="0 0 24 24" width="24" height="24" fill="#2dd4bf">
              ...
              <div>
                ...
                <div style={{ fontSize: '0.85rem', color: '#8b949e' }}>256-bit SSL encryption</div>
              </div>
            </div>
            ...
            <div style={{ 
              ...
              <div>
                <span style={{ color: '#8b949e', fontSize: '0.9rem' }}>Total Due Today</span>
                <div style={{ fontSize: '0.75rem', color: '#ff6b35', marginTop: '0.25rem' }}>
            ...
            <button
              ...
              style={{
                ...
                gap: '0.75rem',
                boxShadow: plan.id === 'full' ? '0 8px 35px rgba(45, 212, 191, 0.35)' : 'none',
                transition: 'all 0.3s'
              }}
            >
              {loading ? (
            ...
            <div style={{ 
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <div style={{ color: '#8b949e', fontSize: '0.7rem' }}>Secure</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '1.25rem', marginBottom: '0.25rem' }}>✓</div>
                <div style={{ color: '#8b949e', fontSize: '0.7rem' }}>Verified</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '1.25rem', marginBottom: '0.25rem' }}>⭐</div>
                <div style={{ color: '#8b949e', fontSize: '0.7rem' }}>5-Star</div>
              </div>
              <div style={{ textAlign: 'center' }}>
                <div style={{ fontSize: '1.25rem', marginBottom: '0.25rem' }}>🛡️</div>
                <div style={{ color: '#8b949e', fontSize: '0.7rem' }}>Guaranteed</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{ 
          ...
          <p style={{ color: '#8b949e', marginBottom: '1rem', fontSize: '1rem' }}>
